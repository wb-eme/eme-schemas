...
export default {
  ...
  'eme:collector:node:form:v1': () => import('@wbeme/schemas/eme/collector/node/FormV1'),
  'eme:collector:node:submission:v1': () => import('@wbeme/schemas/eme/collector/node/SubmissionV1'),
  ...
  'eme:marketing:node:campaign:v1': () => import('@wbeme/schemas/eme/marketing/node/CampaignV1'),
  'eme:marketing:node:profile:v1': () => import('@wbeme/schemas/eme/marketing/node/ProfileV1'),
  'eme:marketing:request:search-campaigns-request:v1': () => import('@wbeme/schemas/eme/marketing/request/SearchCampaignsRequestV1'),
  'eme:marketing:request:search-campaigns-response:v1': () => import('@wbeme/schemas/eme/marketing/request/SearchCampaignsResponseV1'),
  'eme:marketing:request:search-profiles-request:v1': () => import('@wbeme/schemas/eme/marketing/request/SearchProfilesRequestV1'),
  'eme:marketing:request:search-profiles-response:v1': () => import('@wbeme/schemas/eme/marketing/request/SearchProfilesResponseV1'),
  ...
  'eme:sys:request:search-picklists-request:v1': () => import('@wbeme/schemas/eme/sys/request/SearchPicklistsRequestV1'),
  'eme:sys:request:search-picklists-response:v1': () => import('@wbeme/schemas/eme/sys/request/SearchPicklistsResponseV1'),
