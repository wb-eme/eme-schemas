// @link http://schemas.wbeme.com/json-schema/eme/users/command/grant-roles-to-user/1-0-0.json#
...
export default class GrantRolesToUserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:eme:users:command:grant-roles-to-user:1-0-0', GrantRolesToUserV1,
      [
...
MessageResolver.register('eme:users:command:grant-roles-to-user', GrantRolesToUserV1);
