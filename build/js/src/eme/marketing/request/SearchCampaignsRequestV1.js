// @link http://schemas.wbeme.com/json-schema/eme/marketing/request/search-campaigns-request/1-0-0.json#
...
import SearchCampaignsSort from '@wbeme/schemas/eme/marketing/enums/SearchCampaignsSort';
import T from '@gdbots/pbj/types';

export default class SearchCampaignsRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create('sort', T.StringEnumType.create())
          .withDefault(SearchCampaignsSort.SENT_AT_DESC)
          .classProto(SearchCampaignsSort)
          .build(),
...
const M = SearchCampaignsRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:marketing:request:search-campaigns-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:marketing:request:search-campaigns-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:marketing:request:search-campaigns-request:v1';
