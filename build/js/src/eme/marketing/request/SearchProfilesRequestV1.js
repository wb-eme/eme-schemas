// @link http://schemas.wbeme.com/json-schema/eme/marketing/request/search-profiles-request/1-0-0.json#
...
import SearchProfilesSort from '@wbeme/schemas/eme/marketing/enums/SearchProfilesSort';
import T from '@gdbots/pbj/types';

export default class SearchProfilesRequestV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
    ...
    return new Schema(this.SCHEMA_ID, this,
      [
        ...
        Fb.create('sort', T.StringEnumType.create())
          .withDefault(SearchProfilesSort.RELEVANCE)
          .classProto(SearchProfilesSort)
          .build(),
      ],
      this.MIXINS,
    );
...
const M = SearchProfilesRequestV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:marketing:request:search-profiles-request:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:marketing:request:search-profiles-request';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:marketing:request:search-profiles-request:v1';
