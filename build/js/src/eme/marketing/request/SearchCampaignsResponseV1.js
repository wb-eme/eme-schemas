// @link http://schemas.wbeme.com/json-schema/eme/marketing/request/search-campaigns-response/1-0-0.json#
...
export default class SearchCampaignsResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = SearchCampaignsResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:marketing:request:search-campaigns-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:marketing:request:search-campaigns-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:marketing:request:search-campaigns-response:v1';
