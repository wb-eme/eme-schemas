// @link http://schemas.wbeme.com/json-schema/eme/marketing/request/search-profiles-response/1-0-0.json#
...
export default class SearchProfilesResponseV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = SearchProfilesResponseV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:marketing:request:search-profiles-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:marketing:request:search-profiles-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:marketing:request:search-profiles-response:v1';
