...
export default class ProfileV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = ProfileV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:marketing:node:profile:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:marketing:node:profile';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:marketing:node:profile:v1';
