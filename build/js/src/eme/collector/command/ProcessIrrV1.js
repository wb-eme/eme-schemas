...
const M = ProcessIrrV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:collector:command:process-irr:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:collector:command:process-irr';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:collector:command:process-irr:v1';
