...
export default class SubmissionV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = SubmissionV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:collector:node:submission:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:collector:node:submission';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:collector:node:submission:v1';
