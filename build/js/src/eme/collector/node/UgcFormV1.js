// @link http://schemas.wbeme.com/json-schema/eme/collector/node/ugc-form/1-0-0.json#
...
export default class UgcFormV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = UgcFormV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:eme:collector:node:ugc-form:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'eme:collector:node:ugc-form';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'eme:collector:node:ugc-form:v1';
