...
export default class SolicitCreatedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
   */
  static defineSchema() {
    return new Schema('pbj:eme:solicits:event:solicit-created:1-0-0', SolicitCreatedV1,
      [],
      [
...
GdbotsPbjxEventV1Trait(SolicitCreatedV1);
MessageResolver.register('eme:solicits:event:solicit-created', SolicitCreatedV1);
Object.freeze(SolicitCreatedV1);
Object.freeze(SolicitCreatedV1.prototype);
