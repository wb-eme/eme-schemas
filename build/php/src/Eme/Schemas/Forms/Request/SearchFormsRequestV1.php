...
{
    const SCHEMA_ID = 'pbj:eme:forms:request:search-forms-request:1-0-0';
    const SCHEMA_CURIE = 'eme:forms:request:search-forms-request';
    const SCHEMA_CURIE_MAJOR = 'eme:forms:request:search-forms-request:v1';
    const MIXINS = [
