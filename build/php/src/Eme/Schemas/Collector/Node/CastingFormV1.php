...
{
    const SCHEMA_ID = 'pbj:eme:collector:node:casting-form:1-0-0';
    const SCHEMA_CURIE = 'eme:collector:node:casting-form';
    const SCHEMA_CURIE_MAJOR = 'eme:collector:node:casting-form:v1';
    const MIXINS = [
