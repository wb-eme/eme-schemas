...
{
    const SCHEMA_ID = 'pbj:eme:collector:node:ugc-form:1-0-0';
    const SCHEMA_CURIE = 'eme:collector:node:ugc-form';
    const SCHEMA_CURIE_MAJOR = 'eme:collector:node:ugc-form:v1';
    const MIXINS = [
