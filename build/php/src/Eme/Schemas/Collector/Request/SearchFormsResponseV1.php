...
{
    const SCHEMA_ID = 'pbj:eme:collector:request:search-forms-response:1-0-0';
    const SCHEMA_CURIE = 'eme:collector:request:search-forms-response';
    const SCHEMA_CURIE_MAJOR = 'eme:collector:request:search-forms-response:v1';
    const MIXINS = [
