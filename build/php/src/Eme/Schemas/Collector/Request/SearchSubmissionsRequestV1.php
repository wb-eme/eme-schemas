...
{
    const SCHEMA_ID = 'pbj:eme:collector:request:search-submissions-request:1-0-0';
    const SCHEMA_CURIE = 'eme:collector:request:search-submissions-request';
    const SCHEMA_CURIE_MAJOR = 'eme:collector:request:search-submissions-request:v1';
    const MIXINS = [
