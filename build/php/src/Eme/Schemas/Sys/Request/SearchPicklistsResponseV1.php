...
{
    const SCHEMA_ID = 'pbj:eme:sys:request:search-picklists-response:1-0-0';
    const SCHEMA_CURIE = 'eme:sys:request:search-picklists-response';
    const SCHEMA_CURIE_MAJOR = 'eme:sys:request:search-picklists-response:v1';
    const MIXINS = [
