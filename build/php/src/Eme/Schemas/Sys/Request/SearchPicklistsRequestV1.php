...
namespace Eme\Schemas\Sys\Request;

use Eme\Schemas\Sys\Enum\SearchPicklistsSort;
...
{
    const SCHEMA_ID = 'pbj:eme:sys:request:search-picklists-request:1-0-0';
    const SCHEMA_CURIE = 'eme:sys:request:search-picklists-request';
    const SCHEMA_CURIE_MAJOR = 'eme:sys:request:search-picklists-request:v1';
    const MIXINS = [
