...
use Eme\Schemas\Marketing\Enum\SearchProfilesSort;
...
final class SearchProfilesRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:eme:marketing:request:search-profiles-request:1-0-0';
    const SCHEMA_CURIE = 'eme:marketing:request:search-profiles-request';
    const SCHEMA_CURIE_MAJOR = 'eme:marketing:request:search-profiles-request:v1';
    const MIXINS = [
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create('sort', T\StringEnumType::create())
                    ...
                    ->className(SearchProfilesSort::class)
                    ->build(),
            ],
            self::MIXINS
        );
