...
final class SearchCampaignsResponseV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:eme:marketing:request:search-campaigns-response:1-0-0';
    const SCHEMA_CURIE = 'eme:marketing:request:search-campaigns-response';
    const SCHEMA_CURIE_MAJOR = 'eme:marketing:request:search-campaigns-response:v1';
    const MIXINS = [
