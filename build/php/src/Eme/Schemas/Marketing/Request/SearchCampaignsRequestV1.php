...
namespace Eme\Schemas\Marketing\Request;

use Eme\Schemas\Marketing\Enum\CampaignSendStatus;
use Eme\Schemas\Marketing\Enum\SearchCampaignsSort;
...
final class SearchCampaignsRequestV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:eme:marketing:request:search-campaigns-request:1-0-0';
    const SCHEMA_CURIE = 'eme:marketing:request:search-campaigns-request';
    const SCHEMA_CURIE_MAJOR = 'eme:marketing:request:search-campaigns-request:v1';
    const MIXINS = [
        ...
        return new Schema(self::SCHEMA_ID, __CLASS__,
            [
                ...
                Fb::create('sort', T\StringEnumType::create())
                    ...
                    ->className(SearchCampaignsSort::class)
                    ->build(),
