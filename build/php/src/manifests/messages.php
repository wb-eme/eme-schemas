...
return [
    ...
    'eme:collector:node:form:v1' => 'Eme\Schemas\Collector\Node\FormV1',
    'eme:collector:node:submission:v1' => 'Eme\Schemas\Collector\Node\SubmissionV1',
    ...
    'eme:marketing:node:campaign:v1' => 'Eme\Schemas\Marketing\Node\CampaignV1',
    'eme:marketing:node:profile:v1' => 'Eme\Schemas\Marketing\Node\ProfileV1',
    'eme:marketing:request:search-campaigns-request:v1' => 'Eme\Schemas\Marketing\Request\SearchCampaignsRequestV1',
    'eme:marketing:request:search-campaigns-response:v1' => 'Eme\Schemas\Marketing\Request\SearchCampaignsResponseV1',
    'eme:marketing:request:search-profiles-request:v1' => 'Eme\Schemas\Marketing\Request\SearchProfilesRequestV1',
    'eme:marketing:request:search-profiles-response:v1' => 'Eme\Schemas\Marketing\Request\SearchProfilesResponseV1',
    'eme:sys:node:picklist:v1' => 'Eme\Schemas\Sys\Node\PicklistV1',
    'eme:sys:node:tenant:v1' => 'Eme\Schemas\Sys\Node\TenantV1',
    'eme:sys:request:search-picklists-request:v1' => 'Eme\Schemas\Sys\Request\SearchPicklistsRequestV1',
    'eme:sys:request:search-picklists-response:v1' => 'Eme\Schemas\Sys\Request\SearchPicklistsResponseV1',
