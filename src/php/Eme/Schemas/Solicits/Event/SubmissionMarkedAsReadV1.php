...
final class SubmissionMarkedAsReadV1 extends AbstractMessage implements
    SubmissionMarkedAsRead,
    AccountRefV1,
    EventV1,
    TrackedMessageV1
  
{
    ...
    {
        return new Schema('pbj:eme:solicits:event:submission-marked-as-read:1-0-0', __CLASS__,
            [
