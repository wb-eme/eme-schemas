...
use Gdbots\Schemas\Pbjx\Mixin\SearchEventsRequest\SearchEventsRequestV1Trait as GdbotsPbjxSearchEventsRequestV1Trait;
  ...
  
{
    ...
    use GdbotsPbjxSearchEventsRequestV1Trait;
